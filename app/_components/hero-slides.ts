...
export const FALLBACK_HERO_SLIDES: HeroSlide[] = [
  {
    ...
    body: 'Lie down on every mattress we sell, in person — showrooms in Koreatown, West LA, La Brea, Studio City & Glendale. Free white-glove delivery across Los Angeles.',
