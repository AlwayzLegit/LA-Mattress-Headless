...
// TEMPORARY one-shot ISR flush for the homepage so the #13 graphics
// additions replace the stale 6h-TTL prerender. Key-guarded; removed
// right after a single use.
