...
const CMS_PAGE_FAQS: Record<string, FaqItem[]> = {
  'shipping-and-delivery': [
    ...
    },
    {
      ...
      a: `Yes, we deliver to most of Southern California (LA County, Orange County, Ventura County, parts of San Bernardino and Riverside). Delivery is still free on orders over $499 within a 50-mile radius of our Studio City showroom. Outside that range, a flat-rate delivery fee applies, call ${SITE_PHONE_DISPLAY} for a quote.`,
    },
    {
  ...
  'love-your-bed-guarantee': [
    ...
    },
    {
      ...
      a: 'The Love Your Bed Guarantee covers one exchange per purchase. If the second mattress isn\'t right either, contact us and we\'ll work with you, but it\'s case-by-case rather than a blanket guarantee. Try mattresses in-store or take the 2-minute sleep quiz first to narrow the field.',
    },
    {
  ...
  'warranty': [
    ...
    },
    {
      ...
      a: `Call ${SITE_PHONE_DISPLAY} or email lamattressplus@gmail.com with your invoice number and photos of the issue. We coordinate the inspection (often done at home or via photos) and submit the claim to the manufacturer on your behalf.`,
    },
    {
  ...
  'mattress-store-contact': [
    {
      ...
      a: `Three ways: call ${SITE_PHONE_DISPLAY} between 10 AM and 8 PM Pacific, email lamattressplus@gmail.com (we reply within one business day), or visit any of our 5 LA showrooms during open hours. No appointment needed.`,
    },
    {
    ...
    },
    {
      ...
      a: 'Email your resume to lamattressplus@gmail.com with "Career" in the subject line. We hire showroom sleep consultants and warehouse + inventory team members. Check our Careers page for current openings.',
    },
  ],
  ...
  'lowest-price-guarantee': [
    ...
    },
    {
      ...
      a: `The price match requires same mattress, same model number, same size. If we don't carry it, we can usually special-order it from the brand at the matched price. Call ${SITE_PHONE_DISPLAY} with the brand + model and we'll confirm.`,
    },
    {
